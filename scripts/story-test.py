...
_RE_SMELL    = re.compile(r'\[SMELL[\s:(]')   # matches [SMELL: "..."] and [SMELL(...]
_RE_TASTE    = re.compile(r'\[TASTE[\s:(]')   # matches [TASTE: "..."] and [TASTE(...]
_RE_TOUCH    = re.compile(r'\[TOUCH[\s:(]')   # matches [TOUCH: "..."] and [TOUCH(...]
_RE_ENV      = re.compile(r'\[ENVIRONMENT[\s:(]')
